<script lang="ts">
    ...
    onMount(async () => {
        const entries = await readDir('C:\\Users\\reece\\OneDrive\\Documents\\Projects\\simple-editor');
        for (const entry of entries) {
            ...
            if (entry.isDirectory) {
                ...
                div.innerHTML = `
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="m13.71 4.29l-3-3L10 1H4L3 2v12l1 1h9l1-1V5zM13 14H4V2h5v4h4zm-3-9V2l3 3z" clip-rule="evenodd"/></svg>
                `
...
<div class="w-48 min-w-48 max-w-48 h-full border-zinc-700 border-r z-10 flex flex-col">
    ...
    <div class="border-zinc-700 border-b h-9 flex place-items-center text-white justify-evenly">
    ...
    <div bind:this={fileTree} class="flex flex-col pt-2 gap-0.5 text-white text-sm" />
